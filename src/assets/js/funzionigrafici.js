(function (global) {
  ...
  function renderMonteCarloChart(result) {
    ...
    if (!canvas || !global.Chart || !result) return;
  ...
  global.WealthPathCharts = { chartRefs, destroyChart, clearMonteCarloCharts, destroyAll, renderAllocationChart, renderPortfolioChart, renderMonteCarloChart, renderHistogramChart };
})(window);
